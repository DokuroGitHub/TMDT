...
<script runat="server">
    ...
    public override bool CheckAuthentication()
    {
        ...
        //đang fix
        var listRoleID = (List<string>)HttpContext.Current.Session[OnlineShop.Common.CommonConstants.SESSION_CREDENTIALS];
        //đã log in
        //ListRoleID rỗng
        if (listRoleID == null)
        {
        ...
        {
            if (listRoleID.Contains(ConfigurationManager.AppSettings["ADMINRoleID"].ToString()) || listRoleID.Contains("USE_CKFINDER"))
            {
                return true;
            }
            else
